     ...
     */
      ...
      var $container = $(
        "<div class='select2-result-member clearfix'>" +
          "<div class='select2-result-member__avatar'><img src='http://127.0.0.1:8000/uploads/members/" + member.id + '/'+ member.member_photo + "' style='width: 40px;float: left;margin-right: 5px;'/></div>" +
