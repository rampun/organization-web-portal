...
<div class="container">
      ...
      <div class="col-md-12">
        @php 
          if(!empty($user_info->member_photo))
              echo '<img src="'.URL::to('/').'/uploads/members/'.$user->id .'/'.$user_info->member_photo .'" width="150px">';
          else 
    ...
    <div class="form-row">
      <div class="form-group col-md-5">
        ...
        @php
          if(!empty($user_info->spouse_name))
      ...
      <div class="form-group col-md-3">
        ...
        @php 
          if(!empty($user_info->spouse_photo))
              echo '<img src="'.URL::to('/').'/uploads/members/'.$user->id .'/'.$user_info->spouse_photo .'" width="150px">';
          else {
            echo '<img src="'.URL::to('/').'/images/pmshk-placeholder.jpg" width="150px">';
          }
        @endphp
      </div>
    </div>
          ...
          <div class="form-group col-md-2">
            @php 
              if(!empty($child->photo))
                  echo '<img src="'.URL::to('/').'/uploads/members/'.$user->id .'/'.$child->photo .'" width="150px">';
              else {
                echo '<img src="'.URL::to('/').'/images/pmshk-placeholder.jpg" width="150px">';
              }
            @endphp
